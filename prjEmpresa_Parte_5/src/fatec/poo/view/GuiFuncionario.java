...
public class GuiFuncionario extends javax.swing.JFrame {
     ...
     */
    public GuiFuncionario(ArrayList<Funcionario> cadFunc, ArrayList<Departamento> cadDepto){
        String[] relDeptos;
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
       ...
       if (cbxTipo.getSelectedIndex() == 0){
        ...
        //Estabelecer a associação binária entre um objeto Departamento
        //com um objeto Funcionario(Horista, Mensalista, Comissionado)
        cadastroD.get(cbxDepartamento.getSelectedIndex()).addFuncionario(func);
        
        //Estabelecer a associação binária entre um objeto Departamento
        //Funcionario(Horista, Mensalista, Comissionado com um objeto Departamento)
        func.setDepartamento(cadastroD.get(cbxDepartamento.getSelectedIndex()));
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (cbxTipo.getSelectedIndex() == 0){
               ...
               ((FuncionarioMensalista)cadastroF.get(posFunc)).setValSalMin(Double.parseDouble(txtValor.getText()));
                  ...
                  ((FuncionarioComissionado)cadastroF.get(posFunc)).setSalBase(Double.parseDouble(txtValor.getText()));
    ...
    private String[] listarDepartamentos(){
        String[] listarDeptos = new String[cadastroD.size()];
        
        for(int x = 0; x < cadastroD.size(); x++){
            listarDeptos[x] = cadastroD.get(x).getNome();
        }
