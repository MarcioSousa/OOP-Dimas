...
public class GuiFuncionario extends javax.swing.JFrame {
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
       ...
       if (cbxTipo.getSelectedIndex() == 0){
        ...
        //Estabelecendo a associação binária entre um objeto Funcionario (Horista, Mensalista ou Comissionado)
        //com um objeto Departamento
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (!(cadastroF.get(posFunc).getDepartamento().getNome()).equals(cbxDepartamento.getSelectedItem())){
            ...
            //estabelece a nova associação binária
            cadastroD.get(cbxDepartamento.getSelectedIndex()).addFuncionario(cadastroF.get(posFunc));
            cadastroF.get(posFunc).setDepartamento(cadastroD.get(cbxDepartamento.getSelectedIndex()));
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (posFunc >= 0){
            ...
            //remove o funcionario do ArrayList de Funcionario
