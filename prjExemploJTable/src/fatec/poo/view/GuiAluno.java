...
public class GuiAluno extends javax.swing.JFrame {
    ...
    public GuiAluno() {
        initComponents();      
        modTbAlu = (DefaultTableModel)tblAluno.getModel();
    }
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        modTbAlu.addRow(linha);
        
        media = (Double.parseDouble(txtNtPrv1.getText()) + 
                Double.parseDouble(txtNtPrv2.getText()))/2;
        
        modTbAlu.setValueAt(Formato.format(media), 
                modTbAlu.getRowCount() -1, 
                4);
        
        if(media < 5){
            modTbAlu.setValueAt("Reprovado", 
                    modTbAlu.getRowCount() -1, 
                    5);
        }else{
            modTbAlu.setValueAt("Aprovado", 
                    modTbAlu.getRowCount() -1, 
                    5);
        }
   ...
   private DefaultTableModel modTbAlu;
